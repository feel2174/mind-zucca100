...
const results: Record<string, ResultContent> = {
    ...
    ISFJ: {
        title: "다정한 헌신자, 세심한 지지자",
        subtitle: "소리 없이 강한 배려의 사랑꾼",
        description: "상대방의 사소한 습관까지 기억하고 챙겨주는 다정한 연인입니다. 갈등을 피하고 평화로운 관계를 유지하기 위해 노력합니다.",
        traits: ["기념일을 정말 잘 챙김", "상대방의 필요를 먼저 파악함", "자신의 상처를 숨길 때가 있음"],
        tips: ["때로는 본인의 속마음을 솔직히 표현해도 괜찮아요", "희생만 하는 연애는 금물!"],
        matching: "ESFP, ESTP",
        image: "🌸",
    },
    INFJ: {
        title: "영혼의 동반자, 깊은 통찰의 로맨티스트",
        subtitle: "정서적 교감을 중요시하는 신비로운 사랑",
        description: "단순한 데이트보다 깊은 대화와 정신적 성장을 함께할 수 있는 관계를 추구합니다. 따뜻하면서도 확고한 신념이 매력적입니다.",
        traits: ["나만의 선이 확실함", "상대방의 성장을 진심으로 응원함", "복잡한 생각에 잠기곤 함"],
        tips: ["생각이 너무 많아질 땐 현실의 즐거움에 집중해 보세요", "혼자만의 동굴 시간을 연인에게 미리 말해주기"],
        matching: "ENFP, ENTP",
        image: "🕯️",
    },
    INTJ: {
        title: "전략적 파트너, 지적인 완벽주의자",
        subtitle: "독립적이고 효율적인 연애 지향",
        description: "연애도 하나의 프로젝트처럼 진중하게 분석하고 계획합니다. 감정 과잉은 피하지만, 신뢰하는 연인에게는 매우 헌신적입니다.",
        traits: ["지적인 자극을 주는 대화 선호", "불필요한 감정 소모를 싫어함", "미래를 함께 설계하는 파트너십"],
        tips: ["가끔은 논리보다 따뜻한 포옹이 더 큰 힘이 돼요", "서투른 감정 표현도 꾸준히 연습해 보기"],
        matching: "ENFP, ENTP",
        image: "🏛️",
    },
    ISTP: {
        title: "쿨한 자유 영혼, 도구 쓰는 로맨티스트",
        subtitle: "담백하지만 함께 있을 때 즐거운 연애",
        description: "구속받는 것을 싫어하며 자유로운 연애를 선호합니다. 말보다는 행동으로 애정을 표현하며, 취미를 공유하는 데이트를 즐깁니다.",
        traits: ["집착은 절대 거부", "순발력 있고 재치가 넘침", "혼자만의 시간이 꼭 필요함"],
        tips: ["연인이 불안하지 않게 연락 빈도를 조금만 높여봐요", "감사한 마음은 말로도 표현하기"],
        matching: "ESFJ, ESTJ",
        image: "🛠️",
    },
    ISFP: {
        title: "다정한 예술가, 순간을 걷는 연인",
        subtitle: "따스한 배려와 감수성이 넘치는 사랑",
        description: "현재 살고 있는 이 순간의 행복을 가장 중요하게 생각합니다. 갈등을 싫어하며 말없고 온화한 태도로 연인을 감싸 안아줍니다.",
        traits: ["미적 감각이 뛰어난 데이트 코스", "상대의 말을 잘 들어주는 경청의 왕", "결정하는 데 시간이 조금 걸림"],
        tips: ["가끔은 주도적으로 데이트를 리드해 보세요", "본인의 불만도 조금씩 표현하는 연습!"],
        matching: "ENFJ, ESFJ",
        image: "🎨",
    },
    INFP: {
        title: "낭만적인 몽상가, 진정한 사랑의 탐구자",
        subtitle: "이상적이고 동화 같은 사랑을 꿈꾸는 스타일",
        description: "사랑에 대해 깊은 의미를 부여하며, 연인을 위해 모든 것을 줄 수 있는 낭만파입니다. 정서적 소통이 안 되면 크게 외로움을 느낍니다.",
        traits: ["풍부한 상상력과 공감 능력", "사랑에 대한 확고한 이상향", "갈등 상황에서 회피 성향"],
        tips: ["현실은 동화보다 복잡할 수 있음을 인정하기", "서운한 점은 그 자리에서 정중히 말해봐요"],
        matching: "ENFJ, ENTJ",
        image: "🌙",
    },
    INTP: {
        title: "지적인 탐구자, 독립적인 연애 박사",
        subtitle: "호기심 많고 엉뚱한 매력의 사랑",
        description: "지적 호기심을 나눌 수 있는 연인을 선호합니다. 사회적 관행보다는 자신들만의 독특한 연애 방식을 만들어가는 것을 좋아합니다.",
        traits: ["감색 자극보다는 팩트 폭격 주의", "엉뚱하지만 기발한 아이디어", "애정 표현에 다소 무심할 수 있음"],
        tips: ["기념일은 캘린더에 미리 등록해두세요!", "논리만큼 중요한 것이 상대방의 기분임을 기억하기"],
        matching: "ENTJ, ESTJ",
        image: "🔬",
    },
    ESTP: {
        title: "활동적인 모험가, 에너자이저 연인",
        subtitle: "스릴 넘치고 지루할 틈 없는 연애",
        description: "활동적인 데이트를 선호하며 모험을 즐킵니다. 적응력이 뛰어나고 현재의 즐거움을 가장 중요시하는 열정적인 사랑꾼입니다.",
        traits: ["자신감 넘치는 태도", "유머 감각과 타고난 센스", "깊은 약속보다는 현재에 충실"],
        tips: ["때로는 차분한 대화의 시간도 가져보세요", "장기적인 미래 계획도 연인과 상담하기"],
        matching: "ISFJ, ISTJ",
        image: "⚡",
    },
    ESFP: {
        title: "즐거운 파티피플, 사교적인 연인",
        subtitle: "함께 있으면 세상이 축제인 사랑",
        description: "사교적이며 밝은 에너지를 연인에게 쏟아붓습니다. 칭찬과 사랑 표현을 아끼지 않으며, 함께 즐거운 경험을 쌓는 것을 행복으로 여깁니다.",
        traits: ["트렌드를 앞서가는 데이트", "놀랄 만큼 솔직한 감정 표현", "쉽게 지루함을 느낄 수 있음"],
        tips: ["감정에 휩쓸려 충동적인 결정을 내리지 않도록 주의", "진지한 고민도 가끔은 들어주세요"],
        matching: "ISFJ, ISTJ",
        image: "🎉",
    },
    ENFP: {
    ...
    ENTP: {
        title: "기발한 토론가, 지적인 고집쟁이",
        subtitle: "재미있고 예측 불허한 연애",
        description: "창의적이고 새로운 시도를 즐킵니다. 고정관념에 얽매이지 않는 연애를 추구하며, 지적인 논쟁조차도 애정 표현의 하나로 생각합니다.",
        traits: ["말솜씨가 화려하고 논리적", "반복되는 데이트는 금물", "자존심이 아주 강함"],
        tips: ["논쟁에서 이기려 하기보다 연인의 편이 되어주세요", "지나친 장난은 상대방에게 상처가 될 수도!"],
        matching: "INFJ, INTJ",
        image: "💡",
    },
    ESTJ: {
        title: "추진력 있는 리더, 든든한 현실주의자",
        subtitle: "체계적이고 확실한 로맨스",
        description: "연애에 있어서도 명확한 규칙과 계획을 선호합니다. 본인의 가치관이 뚜렷하며, 연인에게 책임감 있고 듬직한 모습을 보여줍니다.",
        traits: ["데이트 코스 완벽 설계", "직설적이지만 솔직한 태도", "효율성을 매우 중시함"],
        tips: ["연인의 감정적 투정도 때로는 들어줄 여유를 가져봐요", "지나치게 통제하려 하지 않도록 주의"],
        matching: "ISFP, ISTP",
        image: "📋",
    },
    ESFJ: {
        title: "따뜻한 조력자, 배려 깊은 호스트",
        subtitle: "주변까지 행복하게 만드는 다정한 연애",
        description: "사람들을 챙기는 것을 좋아하며 연인의 기쁨을 자신의 행복으로 여깁니다. 리액션이 좋고 조화로운 관계를 유지하는 데 탁월합니다.",
        traits: ["안정적인 관계 지향", "가족과 친구들에게 연인을 자랑함", "거절하는 것을 힘들어함"],
        tips: ["상대방의 기분에 일희일비하지 않도록 마인드 컨트롤", "가끔은 본인의 의견을 강하게 내비쳐도 좋아요"],
        matching: "ISFP, ISTP",
        image: "☕",
    },
    ENFJ: {
        title: "열정적인 지지자, 정의로운 사랑꾼",
        subtitle: "상대방을 더 빛나게 만드는 성장형 연애",
        description: "연인의 장점을 발견하고 키워주는 데 천부적인 소질이 있습니다. 따뜻한 리더십으로 관계를 이끌며 정서적으로 매우 충만한 연애를 합니다.",
        traits: ["공감 능력이 매우 뛰어남", "미래 지향적인 관계 설계", "상처받아도 웃는 얼굴을 할 때가 많음"],
        tips: ["연인을 챙기느라 자신을 돌보는 일을 소홀히 하지 마세요", "비판을 너무 개인적으로 받아들이지 않기"],
        matching: "INFP, ISFP",
        image: "☀️",
    },
    ENTJ: {
        title: "전략적인 개척자, 야망 있는 파트너",
        subtitle: "함께 성장하고 성공하는 불도저식 사랑",
        description: "자기 계발에 열심이며 연인과 함께 더 나은 미래를 향해 나아가는 것을 즐깁니다. 결단력이 있고 책임감이 강해 연인에게 신뢰를 줍니다.",
        traits: ["확실한 주도권과 리더십", "효율적인 시간 관리와 데이트", "감정보다는 해결책 우선"],
        tips: ["연인이 고민을 말할 땐 해결책보다 공감을 먼저!", "명령조가 되지 않도록 말투에 신경 써보세요"],
        matching: "INFP, INTP",
        image: "🚀",
    },
};
